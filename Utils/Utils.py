...
async def create_voice_channel(guild, channel_name, category_name = "RAPH", user_limit = 6):
...
async def create_text_channel(guild, channel_name, category = "RAPH", user_limit = 6):
